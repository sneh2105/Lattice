...
python run_benchmark.py   # runs all 6 vulnerable + 1 safe scenario, checks against documented thresholds
```
...
same 6 vulnerable agents through AgentScan and through whatever else you're
