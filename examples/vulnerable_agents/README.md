...
python run_benchmark.py   # runs all 5 vulnerable + 1 safe scenario, checks against documented thresholds
```
...
same 5 vulnerable agents through AgentScan and through whatever else you're
